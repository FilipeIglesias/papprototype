                ...
                builder: (context, snap1) {
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        oldStart = widget.snap.data?.docs[index]['start'];
                        oldEnd = widget.snap.data?.docs[index]['end'];
                        int oldRemind = widget.snap.data?.docs[index]['remind'];
                        String oldRepeat =
